...
source \ac{SAR} acquisition and adds uncertainty from radiometric terrain correction, \ac{DEM} and ancillary
...
\ac{NRB} is a Level-1 \ac{ARD} product in which the calibrated \ac{SAR}
measurement is terrain-corrected, radiometrically normalised, resampled, and
delivered on a defined map grid. The \ac{CEOS} \ac{NRB} product family specification
