...
\begin{figure*}
  ...
  \begin{tikzpicture}
    ...
    \node[draw,
          ...
          align = center,
          minimum width=2cm,
          minimum height=1cm] (aux) {$\varpi_{\rm aux} = J(\vec{P},\gamma,\psi,\phi)+ \Delta\varpi_{\rm aux}$};
    ...
    \node[above = of fit, text width = 4cm] (fitleaves) {Corrections, $\Delta\gamma$, $\Delta\psi$, $\Delta\phi$, obtained by manual fit.};
