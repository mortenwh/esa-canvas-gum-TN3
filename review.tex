...
Using gum principles as reference in general. If a reference is not explicitly
given, the described terms are based on \cite{JCGMGUM}.
...
\begin{itemize}
  \item Interoperability: the ability of data or tools from non-cooperating resources to integrate or work together with minimal effort \cite{wilkinson16}.
